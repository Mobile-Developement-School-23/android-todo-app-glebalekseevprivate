package com.glebalekseevjk.todo.todolist.presentation.rv.adapter
...
import com.glebalekseevjk.todo.todolist.presentation.rv.callback.TodoItemDiffCallBack
...
import com.glebalekseevjk.todo.todolist.presentation.databinding.NewTodoItemRvBinding
import com.glebalekseevjk.todo.todolist.presentation.databinding.TodoItemRvBinding
import java.text.SimpleDateFormat
import java.util.Locale
import javax.inject.Inject

/**
 Этот класс отвечает за управление адаптером, отображающим список задач.
 */
