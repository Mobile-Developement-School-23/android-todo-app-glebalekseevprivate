...
interface RepositoryModule {
    ...
    @AppComponentScope
    @Binds
    fun bindSynchronizationRepository(synchronizationRepositoryImpl: SynchronizationRepositoryImpl): SynchronizationRepository

    @AppComponentScope
    @Binds
    fun bindSynchronizationSchedulerManager(synchronizationSchedulerManagerImpl: SynchronizationSchedulerManagerImpl): SynchronizationSchedulerManager
}